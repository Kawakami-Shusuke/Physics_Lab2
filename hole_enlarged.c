...
void rectangle_3_volt() {
    // 頂点の定義
    double Ax = 470.0, Ay = 1020.0;
    double Bx = 550.0, By = 1120.0;
    double Dx = 800.0, Dy = 760.0;
...
void rectangle_6_volt() {
    // 頂点の定義
    double Ex = 510.0, Ey = 2110.0;
    double Fx = 510.0, Fy = 2240.0;
    double Hx = 1210.0, Hy = 2120.0;
...
void hole(){ //holeにはフラグを立てておく。(あとで計算)
     // 頂点の定義
    double Ix = 1390.0, Iy = 1120.0;
    double Jx = 1470.0, Jy = 1670.0;
    double Lx = 1470.0, Ly = 1110.0;
